...
<template>
    <div v-if="chosenBoba" class="page-container">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, iste aperiam vitae officiis iusto excepturi
            sint pariatur velit eos placeat.</p>
        <section>
            <p>Extra boba +5 SEK
                <input type="checkbox" v-model="extraBoba" onchange="(()=>{extraBoba = !extraBoba})" name="" id="">
            </p>
            <p>Lägg till yelly +5 SEK
                <input type="checkbox" v-model="addJelly" onchange="(()=>{addJelly = !addJelly})" name="" id="">
            </p>
        </section>
    </div>
